...
public class BearerAdmStatus {
    public static XrancPdu constructPacket(ECGI ecgi, CRNTI crnti) {
        ...
        BearerAdmissionStatus bearerAdmStatus = new BearerAdmissionStatus();

        bearerAdmStatus.setEcgi(ecgi);
        bearerAdmStatus.setCrnti(crnti);
        bearerAdmStatus.setNumErabs(new BerInteger(0));
        bearerAdmStatus.setErabResponse(new ERABResponse());


        XrancPduBody body = new XrancPduBody();
        body.setBearerAdmissionStatus(bearerAdmStatus);
